            ...
            <div name="alert" class="mt-3">
                <?php if ($this->session->flashdata('success')) : ?>
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        Regitrasi <strong>berhasil</strong> <?= $this->session->flashdata('success'); ?>.
                ...
                <form action="<?php echo base_url('homepage/c_login_lapor'); ?>" method="post">
                    <div class="text-center">
                        <a href="<?= base_url(); ?>homepage">
                            <img class="mb-4" src="<?= base_url();?>/images/logoG.png"  height="72">
                        </a>
                        <h1 class="h3 mb-3 font-weight-normal">Login for Reporters</h1>
                    </div>
                    <div class="text-center">
                ...
                <div class="pt-4">
                    <a class="nav-link font-italic float-left" href="<?= base_url(); ?>homepage">HomePage</a>
                    <a class="nav-link font-italic text-right" href="<?= base_url(); ?>homepage/v_regist_lapor">SignUp</a>
                </div>
            </div>
        </div>
