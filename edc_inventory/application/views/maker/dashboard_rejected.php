<div class="container-fluid">
    ...
    <nav class="navbar navbar-expand my-3">
        <a class="btn btn-sm btn-outline-warning mr-2" href="<?= site_url('maker/index')?>">Pending</a>
        <a class="btn btn-sm <?php if($status=='rejected'){echo 'btn-secondary';};?> mr-2" href="<?= site_url('maker/rejected')?>">Rejected</a>
        ...
        <tbody id="myTable">
            ...
            <tr>
                ...
                <td style="vertical-align: middle;">
                    ...
                    <div class="modal fade" id="ajul-<?=$row['id']?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" data-backdrop="static" aria-hidden="true">
                        <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
