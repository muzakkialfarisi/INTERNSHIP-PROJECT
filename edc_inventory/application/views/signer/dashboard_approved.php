<div class="container-fluid">
    ...
    <a class="btn btn-sm btn-outline-warning mr-2" href="<?= site_url('signer/index')?>">Pending</a>
        <a class="btn btn-sm btn-outline-secondary mr-2" href="<?= site_url('signer/rejected')?>">Rejected</a>
        <a class="btn btn-sm <?php if($status=='approved'){echo 'btn-success';};?> mr-2" href="<?= site_url('signer/approved')?>">Approved</a>
