<div class="container-fluid">
    <nav class="navbar navbar-expand my-3">
        <a class="btn btn-sm btn-outline-warning mr-2" href="<?= site_url('checker/index')?>">Pending</a>
        <a class="btn btn-sm <?php if($status=='rejected'){echo 'btn-secondary';};?> mr-2" href="<?= site_url('checker/rejected')?>">Rejected</a>
