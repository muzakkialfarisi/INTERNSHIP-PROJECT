      ...
      <div class="modal-content" >
        ...
        <?php if ($this->session->flashdata('success')) : ?>
          <div class="alert alert-success alert-dismissible fade show" role="alert">
              Serial Number <strong><?= $this->session->flashdata('success'); ?></strong>
              <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
              </button>
          </div>
        <?php endif; ?>
      <form action="<?= site_url('edc/input_edc_process')?>" method="post">
          <div class="modal-header">
              <h5 class="modal-title" id="exampleModalCenterTitle">Create New EDC</h5>
          </div>
          <div class="modal-body" style="font-size:14px">                    
            <div class="form-row">
                <div class="form-group col-md">
                    <label>Serial Number</label>
                    <input type="text" class="form-control form-control-sm" name="sn" required="" style="text-transform:uppercase">
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md">
                    <label>MID</label>
                    <input type="text" class="form-control form-control-sm" name="mid" style="text-transform:uppercase" id="mid_check" maxlength="12">
                    <div id="message_mid"></div>
                </div>
                <div class="form-group col-md">
                    <label>TID</label>
                    <input type="text" class="form-control form-control-sm" name="tid" style="text-transform:uppercase" id="tid_check" maxlength="8">
            ...
            <div class="form-row">
                <div class="form-group col-md">
                    ...
                    <select class="form-control form-control-sm" name="peruntukan" required="">
                        <option value="">Select...</option>
                        <option value="Merchant">Merchat</option>
            ...
            <div class="form-row">
                <div class="form-group col-md">
                    ...
                    <select class="form-control form-control-sm" name="posisi_kanwil" required="" id="posisi_kanwil"> 
                        <option>Pilih</option>
                        <?php 
                        $sql="SELECT * from uker group by nama_kanwil ";
                ...
                <div class="form-group col-md">
                    <label>Posisi Uker</label>
                    <select class="form-control form-control-sm" name="posisi_uker" required="" id="posisi_uker"> </select>
                </div>
            </div>
            <div class="form-row">
                <div class="form-group col-md">
            ...
            <div class="form-row">
                ...
                <div class="form-group col-md text-center">
                  <input class="form-check-input" type="checkbox" name="gprs" value="1" checked>
                  <label class="form-check-label">
                    GPRS
                  </label>
                </div>
                <div class="form-group col-md text-center">
                  <input class="form-check-input" type="checkbox" name="lan" value="1" checked>
                  <label class="form-check-label">
                    LAN
                  </label>
                </div>
                <div class="form-group col-md text-center">
                  <input class="form-check-input" type="checkbox" name="dialup" value="1" checked>
                  <label class="form-check-label">
                    Dial-Up
                  </label>
                </div>
                <div class="form-group col-md text-center">
                  <input class="form-check-input" type="checkbox" name="contactless" value="1" >
                  <label class="form-check-label">
                    Contactless
                  </label>
                </div>
